 ...
 * 
 */
package com.wimove.content.persistence.filter;
...
import com.wimove.content.hibernate.DistanceOrder;
import com.wimove.content.hibernate.DistanceProjection;
...
public class SearchFilterCriteriaBuilder {
	...
	public static List<Item> buildContentCriteria(Criteria criteria,
		...
		if (searchFilter.getLimit() == null) {
			criteria
					.setMaxResults(com.wimove.constant.Constants.MAX_RESULT_PER_PAGE);
		} else {
