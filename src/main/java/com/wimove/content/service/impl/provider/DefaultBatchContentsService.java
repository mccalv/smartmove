 ...
 * 
 */
package com.wimove.content.service.impl.provider;
...
import com.wimove.service.audio.TTSServiceManager;
...
public class DefaultBatchContentsService implements BatchContentsService {
	...
	public void createMp3(int howmany) {
		...
		List<HashMap<String, String>> itemsWithoutLocale = batchRepository
				.getItemsWithoutLocale(howmany);
		for (HashMap<String, String> map : itemsWithoutLocale) {
