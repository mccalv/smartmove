 ...
 * 
 */
package com.wimove.content.geometry;
...
public class GeoLocHelper {
	...
	public static Point createPoint(Float longitude, Float latitude) {
		...
		GeometryFactory factory = new GeometryFactory(new PrecisionModel(
				PrecisionModel.maximumPreciseValue), com.wimove.constant.SRID.WGS84_SRID
				.getSRID());
	...
	public static Polygon createPolygonFromString(String latLonCommaSeparated) {
		try {
			GeometryFactory geometryFactory = new GeometryFactory(
					...
					com.wimove.constant.SRID.WGS84_SRID.getSRID());
	...
	public static MultiLineString createMultiLineString(String[] wktLineStrings) {
		...
		GeometryFactory factory = new GeometryFactory(new PrecisionModel(
				PrecisionModel.FLOATING), com.wimove.constant.SRID.WGS84_SRID
				.getSRID());
	...
	public static Polygon createPolygonBox(double lng, double lat,
		...
		double angulardistance = distance
				/ com.wimove.constant.Constants.RADIUS_OF_EARTH_IN_METERS;
		...
		try {
			...
			polygon.setSRID(com.wimove.constant.SRID.WGS84_SRID.getSRID());
			return polygon;
	...
	public static Geometry convertFromHEXEWKBToGeometry(String hewewkbt) {
		try {
			...
			geometry.setSRID(com.wimove.constant.SRID.WGS84_SRID.getSRID());
			return geometry;
		} catch (com.vividsolutions.jts.io.ParseException e) {
